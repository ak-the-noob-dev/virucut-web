...
import { ProductSingleViewLimit } from "@/components/ProductView/productView";
...
export default function ProductView() {
  ...
  const productCategories = [
    {
      categoryName: "Abrasive Products",
      categoryDesc: "Lorem Ipsum Lorem ",
    },
    {
      categoryName: "Gun & BTA Drills",
      categoryDesc: "Lorem Ipsum ",
    },
    {
      categoryName: "Milling & Slitting Cutters",
      categoryDesc: "Lorem Ipsum ",
    },
    {
      categoryName: "Special & Workholding Tools",
      categoryDesc: "Lorem Ipsum ",
    },
  ];
  const productsByCategory: { [key: string]: string[] } = {
    ...
    "Gun & BTA Drills": ["Gun Drill", "BTA Drill"],
    "Milling & Slitting Cutters": ["Milling Cutter", "Slitting Cutter"],
    "Special & Workholding Tools": ["Special Tool", "Workholding Tool"],
  };
  ...
  return (
    <main>
          ...
          <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">
            <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
              ...
              <HeroButton
                ...
                className="px-8 mt-8"
                onclick={() => handleNavTo("contact-us")}
              />
            </div>
      ...
      <section className="w-full bg-blue-100 flex flex-col mt-12">
        <h6 className="text-3xl font-bold p-4 text-center font-verdana pt-8">
          Our Products
        </h6>
        <div className="flex flex-row gap-4 p-4 overflow-x-scroll w-full custom-x-scrollbar">
          {productCategories &&
            productCategories.map((item, index) => {
              return (
                <div
                  className="flex flex-row bg-gray-50 p-2 rounded-md  leading-6 h-52 w-[30%] min-w-[30%]"
                  key={index}
                >
                  <Image
                    src={
                    ...
                    width={100}
                    height={100}
                    className="rounded-md h-48 w-44 min-w-44 object-fill"
                  />
                  <div className="flex flex-col p-2 gap-2">
                    <div className="text-xl font-w">{item.categoryName}</div>
                    <div className="">{item.categoryDesc}</div>
                    <button
                      className="text-green-600 hover:text-green-700 underline decoration-2"
        ...
        {selectedCategory && (
          <div className="p-4 bg-white">
            <h6 className="text-3xl font-bold p-4 text-center font-verdana">
              {selectedCategory}
            </h6>
            <div className="">
