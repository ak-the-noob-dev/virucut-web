...
import ModalWithForm from "@/components/Modal/modalWForm";
...
export default function Home() {
  ...
  const [isModelShowed, setIsModelShowed] = useState(false);
  ...
  useEffect(() => {
    ...
    if (!isModalOpen) {
      const timeOut = setTimeout(() => {
        setIsModalOpen(true);
        setIsModelShowed(true);
      }, 6000);
      return () => clearTimeout(timeOut);
    }
  }, [isModalOpen, isModelShowed]);
  ...
  return (
    <main>
      ...
      <section className="min-h-[30vh] my-12 md:my-32 lg:my-32 bg-blue-200 flex flex-col justify-center items-center">
        <div className=" mb-6 text-center text-black text-3xl font-bold tracking-tighter sm:text-5xl py-5 font-verdana my-10">
      ...
      <div className="">
        {downloaded ? (
          <DownloadButton onClick={handleDownload} isLoading={true} />
        ) : (
          <DownloadButton onClick={handleDownload} isLoading={false} />
        )}
      </div>
